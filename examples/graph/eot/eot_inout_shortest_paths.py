...
INPUT_DIR = DATA_DIR / 'eot' / 'input'
OUTPUT_DIR = DATA_DIR / 'eot' / 'output'
FILE_NAME = 'endo_match_inout_chems.xlsx'
...
def get_graph_name(cluster_num, exclude):
    graphName = f"EoT-cluster{cluster_num}-inout-shortest-paths"
    name_postfix = ""
    if exclude == 'ALL':
